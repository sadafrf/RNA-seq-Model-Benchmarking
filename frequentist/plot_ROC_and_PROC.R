...
# Bayesian NB (Metropolis)
# ----------------------------------------------------
# ----------------------------------------------------
#bayes_nb_means <- read.table("../data/bayes_nb_input_for_roc.txt")
#bayes_nb_all_data <- read.table("../data/z_thresholding_for_auc_curve.txt")
bayes_nb_metadata <- read.table("../data/iteration_metadata.txt", header=TRUE)

bayes_nb_roc_data <- read.table("../data/roc_input_negative_binomial_bayesian.txt")
...
# Bayesian NB (INLA)
# ---------------------------------------------
bayes_nb_inla_roc_data <- readRDS("../data/auc___auroc_nb_inla.rds")
bayes_nb_inla_pr_data <- readRDS("../data/auc___auprc_nb_inla.rds")
...
# ----------------------------------------------------
# ----------------------------------------------------
bayesian_gaussian_auroc <- readRDS("../data/benchmarking___auroc_bayesian_gaussian.rds")
bayesian_gaussian_pr <- readRDS("../data/benchmarking___auprc_bayesian_gaussian.rds")
bayesian_gaussian_results <- readRDS("../data/benchmarking___results_bayesian_gaussian.rds")
